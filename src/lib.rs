...
impl BigDecimal {
    ...
    ///
    /// ```
    /// use datom_bigdecimal::{BigDecimal, Zero};
    ///
    ...
    /// use std::str::FromStr;
    ///
    /// assert_eq!(datom_bigdecimal::BigDecimal::from_str("-1").unwrap().sign(), num_bigint::Sign::Minus);
    /// assert_eq!(datom_bigdecimal::BigDecimal::from_str("0").unwrap().sign(), num_bigint::Sign::NoSign);
    /// assert_eq!(datom_bigdecimal::BigDecimal::from_str("1").unwrap().sign(), num_bigint::Sign::Plus);
    /// ```
    #[inline]
    ...
    /// use std::str::FromStr;
    ///
    /// assert_eq!(datom_bigdecimal::BigDecimal::from_str("1.1").unwrap().as_bigint_and_exponent(),
    ...
    /// use std::str::FromStr;
    ///
    /// assert_eq!(datom_bigdecimal::BigDecimal::from_str("1.1").unwrap().into_bigint_and_exponent(),
    ///            (num_bigint::BigInt::from_str("11").unwrap(), 1));
    #[inline]
...
impl Ord for BigDecimal {
    ...
    /// use std::str::FromStr;
    ///
    /// let a = datom_bigdecimal::BigDecimal::from_str("-1").unwrap();
    /// let b = datom_bigdecimal::BigDecimal::from_str("1").unwrap();
    /// assert!(a < b);
    /// assert!(b > a);
    /// let c = datom_bigdecimal::BigDecimal::from_str("1").unwrap();
    /// assert!(b >= c);
    /// assert!(c >= b);
    /// let d = datom_bigdecimal::BigDecimal::from_str("10.0").unwrap();
    /// assert!(d > c);
    /// let e = datom_bigdecimal::BigDecimal::from_str(".5").unwrap();
    /// assert!(e < c);
    /// ```
    #[inline]
